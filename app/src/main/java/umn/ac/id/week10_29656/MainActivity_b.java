...
public class MainActivity_b extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Void> {
    ...
    static class ContohLoader extends AsyncTaskLoader<Void> {
        static WeakReference<MainActivity_b> mActivity;
        int mCounter = 0;
        ...
        public ContohLoader(@NonNull Context context, int n,
            ...
            super(context);
            mCounter = n;
            mActivity = new WeakReference<MainActivity_b>(main);
        }
        @Nullable
        @Override
